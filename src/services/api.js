...
export default class Api {
  constructor(timeout=5e3, maxAttempts=5) {
    ...
    // this._domainUrl = 'wss://testnet.binance.vision'; // testnet
    this._domainUrl = 'wss://stream.binance.com'; // mainnet
    this._baseUrl = this._domainUrl + '/ws/';
    this._combinedBaseUrl = this._domainUrl + '/stream?streams=';
    this.subscription = {};
    this.streams = {
